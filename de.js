export default {
    ...
    CAR_EXPERIMENTAL_SUPPORT: 'Experimenteller Support. Funktionen möglicherweise eingeschränkt oder fehlerhaft',
    ...
    ABRP_LINKING: 'ABRP Integration',
    ABRP_LINKING_TEXT: 'Um deine Echtzeitdaten automatisch mit "A Better Routeplanner" (kurz: ABRP) zu teilen, musst du EVNotify die Berechtigung erteilen, deine Daten mit ABRP zu teilen. Beachte, dass du Daten an Dritte weitergibst. EVNotify hat keine Kontrolle über deine Daten, sobald diese mit anderen geteilt wurden. Weitere Informationen findest du in den <a href="https://iternio.com/index.php/integrity-policy/">Datenschutzbestimmungen</a>. Mit dem Erteilen von Berechtigungen akzeptierst du diese Richtlinien automatisch. Mit diesem <a href="https://abetterrouteplanner.com/ref/EVNOTIFY"> Link </a> kannst du einen Monat kostenlos Premium erhalten. Möchtest du ABRP in EVNotify integrieren?',
    ABRP_LINKED_TEXT: 'Du hast dein Konto mit <a href="https://abetterrouteplanner.com">A Better Routeplanner</a> verknüpft. Mit diesem <a href="https://abetterrouteplanner.com/ref/EVNOTIFY">Link</a> kannst du einen Monat kostenlos Premium erhalten.',
    ...
    DATA_OUTDATED_NEVER_CONNECTED: 'Es gab noch nie eine Verbindung mit einem Auto. Bitte verbinde Dein Auto erstmalig.',
    DATA_OUTDATED_WITH_TIMESTAMP: 'Daten veraltet. Zuletzt aktualisiert: ',
    DATA_UPDATED_NEVER: 'Noch nie aktualisiert',
    DATA_UPDATED_TEXT: 'Aktualisiert: ',
    ...
    BATTERY_TEMPERATURE_SHORTS: 'Min / Max / Einlass',
    CUMULATIVE_ENERGY_CHARGED: 'Kumulative Energie geladen',
    CUMULATIVE_ENERGY_DISCHARGED: 'Kumulative Energie entladen',
